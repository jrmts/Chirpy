...
const deleteOneChirps = `-- name: DeleteOneChirps :exec
DELETE FROM chirps WHERE id = $1
`

func (q *Queries) DeleteOneChirps(ctx context.Context, id uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, deleteOneChirps, id)
	return err
}
